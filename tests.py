...
class TestScan(unittest.TestCase):
    ...
    def test_no_differences(self):
        ...
        self.app.scan()
        self.assertEqual(
            self.app.manager.report["matched_files"],
            ["file1.txt", "subdir\\file2.txt", "subdir\\granddir\\file3.txt"],
        )
        self.assertEqual(self.app.manager.report["mismatched_files"], [])
        self.assertEqual(self.app.manager.report["added_files"], [])
        self.assertEqual(self.app.manager.report["moved_files"], [])
    ...
    def test_new_file(self):
        ...
        self.assertEqual(self.app.manager.report["mismatched_files"], [])
        self.assertEqual(
            self.app.manager.report["added_files"], ["new_file.txt"]
        )
        self.assertEqual(self.app.manager.report["moved_files"], [])
        self.assertEqual(self.app.manager.report["removed_files"], [])
        self.assertEqual(self.app.manager.report["errors"], [])
    ...
    def test_new_file_subdir(self):
        ...
        self.assertEqual(self.app.manager.report["mismatched_files"], [])
        self.assertEqual(
            self.app.manager.report["added_files"], ["subdir\\new_file2.txt"]
        )
        self.assertEqual(self.app.manager.report["moved_files"], [])
        self.assertEqual(self.app.manager.report["removed_files"], [])
        self.assertEqual(self.app.manager.report["errors"], [])
    ...
    def test_changed_file_subdir(self):
        ...
        self.assertEqual(
            self.app.manager.report["matched_files"],
            ["file1.txt", "subdir\\granddir\\file3.txt"],
        )
        self.assertEqual(
            self.app.manager.report["mismatched_files"], ["subdir\\file2.txt"]
        )
        self.assertEqual(self.app.manager.report["added_files"], [])
        self.assertEqual(self.app.manager.report["moved_files"], [])
        self.assertEqual(self.app.manager.report["removed_files"], [])
    ...
    def test_moved_file(self):
        ...
        self.assertEqual(self.app.manager.report["added_files"], [])
        self.assertEqual(
            self.app.manager.report["moved_files"],
    ...
    def test_renamed_folder_with_missing_file_in_subdir(self):
        """
        Test that a renamed folder and a file moved into its subfolde
        will both be put under 'moved_files'.
        """
